    ...
    <div className="max-w-6xl mx-auto py-10 px-4">
      ...
      <div className="not-prose text-basefont-[Rubik] font-semibold">
        <p>
          ...
          сети Интернет по адресу: https://isra.kz/policy
        </p>
        ...
        <ul className="px-4 py-2">
          <li>2.2.1 оказания Услуг Пользователю;</li>
          <li className="py-1.5">2.2.2 идентификации Пользователя;</li>
          <li className="py-1.5">2.2.3 взаимодействия с Пользователем;</li>
          <li className="py-1.5">
            2.2.4 направления рекламных материалов и уведомлений;
          </li>
          <li className="py-1.5">
            2.2.5 проведения статистических исследований.
          </li>
        </ul>
