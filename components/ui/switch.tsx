...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "border data-[state=unchecked]:border-border data-[state=checked]:border-primary",
      className
    )}
    {...props}
    ref={ref}
  >
    <SwitchPrimitives.Thumb
      className={cn(
        ...
        "bg-background border border-border data-[state=checked]:border-primary-foreground",
        "shadow-md"
      )}
    />
  </SwitchPrimitives.Root>
